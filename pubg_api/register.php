    ...
    if (!$email) {
        ...
        if ($exists) {
            ...
            if ($stmt->execute([$username, $email, $hashed])) {
                $success = "Registration successful! <a href='login.php'>Login now to find PUBG players.</a>";
            } else {
...
<head>
    <meta charset="UTF-8">
    <title>PUBG Player Finder | Register</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <style>
    /* Your existing styles, adjusted for visibility */
    body {
        min-height: 100vh;
        margin: 0;
    ...
    .success { background: #32e1a521; color: #e7fff6; }
    </style>
</head>
<body>
    ...
    <div class="auth-container">
        ...
        <div class="intro-text">
            Sign up for PUBG Player Finder and start exploring player stats for every battleground hero.
        </div>
        ...
        <form method="POST" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="text" id="reg-username" name="username" required maxlength="32">
            </div>
            <div class="form-group">
                <label for="reg-email">Email</label>
                <input type="email" id="reg-email" name="email" required maxlength="120">
            </div>
            <div class="form-group">
        ...
        <a class="auth-link" href="login.php">Already signed up? Sign in here &rarr;</a>
    </div>
</body>
</html>
